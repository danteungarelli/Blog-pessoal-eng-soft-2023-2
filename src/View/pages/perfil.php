...
// Chamar função validar o token, se for false -> token é inválido e acessa o If
if(!validarToken()){
    // Criar mensagem de erro e atribuir à variável global
            ...
            <div class="card">
                <div class="card-body">
                    <div class="perfil_info">
                        <div class="d-flex">
                            <svg id="icon_perfil" xmlns="http://www.w3.org/2000/svg" width="70" height="70"
